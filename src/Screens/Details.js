...
const Details = (props) => {
  const [product, onChangeText] = React.useState("");
  const [width, onChangeText1] = React.useState("");
  const [length, onChangeText2] = React.useState("");
  const [height, onChangeText3] = React.useState("");
  const [weight, onChangeText4] = React.useState("");
  const [quantity, onChangeText5] = React.useState("");
  const [description, onChangeText6] = React.useState("");
  ...
  return (
    <View style={{ flex: 1, backgroundColor: '#ffffff' }}>
              ...
              <View style={styles.customTabsDiv}>
                ...
                <View style={styles.customTabs}>
                  ...
                  <TouchableOpacity style={styles.customTabCol} onPress={detailsClick}>
                    <Text style={[styles.customTabCount, styles.customTabCountFill]}>2</Text>
              ...
              <View style={styles.formOuter}>
                <View style={styles.formGroupDiv}>
                  <View style={styles.formGroupNew}>
                    <Text style={styles.formLabelNew}>Product Name</Text>
                    <TextInput
                    ...
                    />
                    <Image source={require('../assets/img/proIcon.png')} style={[styles.inputIcon]} />
                  </View>
                </View>
                <View style={styles.formGroupDiv}>
                  <View style={styles.formGroupNew}>
                    <Text style={styles.formLabelNew}>Width</Text>
                    <TextInput
                      style={styles.formControlNew}
                      value={width}
                  ...
                  <View style={styles.formGroupNew}>
                    <Text style={styles.formLabelNew}>Length</Text>
                    <TextInput
                      style={styles.formControlNew}
                      value={length}
                  ...
                  <View style={styles.formGroupNew}>
                    <Text style={styles.formLabelNew}>Height</Text>
                    <TextInput
                      style={styles.formControlNew}
                      value={height}
                ...
                <View style={styles.formGroupDiv}>
                  <View style={styles.formGroupNew}>
                    <Text style={styles.formLabelNew}>Weight</Text>
                    <TextInput
                      style={styles.formControlNew}
                      value={weight}
                  ...
                  <View style={styles.formGroupNew}>
                    <Text style={styles.formLabelNew}>Quantity</Text>
                    <TextInput
                      style={styles.formControlNew}
                      value={quantity}
      ...
      <View style={styles.fixBtnDiv}>
        ...
        <View style={styles.innerFlex}>
          <TouchableOpacity style={styles.btnGradientDiv} onPress={paymentClick}>
            <LinearGradient
              start={{ x: 0, y: 0 }} end={{ x: 1, y: 0 }}
              colors={['#0e558d', '#084677']}
