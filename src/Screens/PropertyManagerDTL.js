...
const PropertyManagerDtl = (props) => {
    // console.log('props', props.route.params);
    let propManagerData = props?.route?.params
    const handleClick = () => {
                                ...
                                <View style={styles.proprtyCardRow}>
                                    <View style={[styles.proprtyCardRight]}>
                                        ...
                                        <Text style={[styles.py7, { color: '#707070' }]}>
                                            {propManagerData?.firstname} {propManagerData?.lastname}
                                        </Text>
                                        <Text
                                            style={[
                                                styles.mediumTitle,
                                        ...
                                        {propManagerData?.document?.length > 0 ?
                                        ...
                                        <Text style={[styles.py7, { color: '#707070' }]}>
                                            {propManagerData?.propertyList?.length}
                                        </Text>
                                    </View>
                                </View>
                            </View>
...
export default PropertyManagerDtl;