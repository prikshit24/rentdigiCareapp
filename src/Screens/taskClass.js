...
const TaskTypes = (props) => {
  const addCardClick = () => {
    // props.history.push("/taskclassAdd");
    props.navigation.navigate('taskclassAdd')
  }
  const TaskdtlClass = () => {
              ...
              <View style={[styles.columnTwo]}>
                ...
                <View style={[styles.mainHdngBtm, styles.mt10]} >
                  <Text style={styles.textBlue} >
                    <Text style={[styles.mainTitle, styles.greyText,]}>Task Class</Text> (6)
                  </Text>
                </View>
              </View>
            </View>
            <View style={[styles.prpertyList]}>
              <TouchableOpacity style={styles.proprtyCardItem} backgroundColor={'#ffffff'} onPress={TaskdtlClass}>
                <View style={styles.proprtyCardCol}>
                  <View style={styles.proprtyCardRow}>
                    <View style={[styles.proprtyCardRight]}>
                      <Text style={[styles.mediumTitle, styles.pt8, styles.textBlue,]}>Call Before Entering</Text>
