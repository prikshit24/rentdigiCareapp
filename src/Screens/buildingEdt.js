...
const BuildingEdt = (props) => {
  const [description, onChangeText9] = React.useState("");
  const [cardCode, onChangeText] = React.useState("");
  ...
  const [cardFloor, onChangeText4] = React.useState("");
    ...
    <View style={{ flex: 1, backgroundColor: '#ffffff' }}>
      ...
      <View style={styles.mainHeaderOuter}>
        <LinearGradient
          ...
          <Text style={styles.headerTitle}>Building Details Edit</Text>
        </LinearGradient>
      </View>
                ...
                <View style={styles.formOuter}>
                  <View style={styles.formGroupDiv}>
                    <View style={styles.formGroupNew}>
                      <Text style={styles.formLabelNew}>Area Code</Text>
                      <TextInput
