    ...
    <View style={{ flex: 1, backgroundColor: '#ffffff' }}>
      ...
      <View style={styles.mainHeaderOuter}>
        <LinearGradient
          ...
          <Text style={styles.headerTitle}>Asset Class Add</Text>
        </LinearGradient>
      </View>
                  ...
                  {/* <View style={styles.formGroupDiv}>
                    <View style={styles.formGroupNew}>
                      ...
                      <View style={styles.dropGroup}>
                        <ModalDropdown isFullWidth={true} style={styles.dropdownInput} textStyle={styles.dropTextStyle} dropdownStyle={styles.dropdownStyle} dropdownTextStyle={styles.dropdownTextStyle} dropdownTextHighlightStyle={styles.dropdownTextHighlightStyle} options={['Yes', 'No']}>
                        </ModalDropdown>
