...
const UserAccountedt = (props) => {

  const [Username, onChangeText] = React.useState("");
  const [password, onChangeText1] = React.useState("");
  const [firstname, onChangeText2] = React.useState("");
  const [secondname, onChangeText3] = React.useState("");
    ...
    <View style={{ flex: 1, backgroundColor: '#ffffff' }}>
      ...
      <View style={styles.mainHeaderOuter}>
        <LinearGradient
          ...
          <Text style={styles.headerTitle}>User Account Edit</Text>
        </LinearGradient>
      </View>
                ...
                <View style={styles.formOuter}>
                  <View style={styles.formGroupDiv}>
                    <View style={styles.formGroupNew}>
                      <Text style={styles.formLabelNew}>Username</Text>
                      <TextInput
                  ...
                  <View style={styles.formGroupDiv}>
                    <View style={styles.formGroupNew}>
                      <Text style={styles.formLabelNew}>Password</Text>
                      <TextInput
                        style={styles.formControlNew}
                        value={password}
                  ...
                  <View style={styles.formGroupDiv}>
                    <View style={styles.formGroupNew}>
                      <Text style={styles.formLabelNew}>Auto Assign</Text>
                      <View style={styles.selectDrop}>
                        <MultiSelect
                  ...
                  <View style={styles.formGroupDiv}>
                    <View style={[styles.formCheckGroupDiv, styles.mr10]}>
                      <View style={[styles.formGroupSimple, styles.checkBoxDiv,]}>
                        ...
                        <Text style={styles.checkBoxTitle}>Confirmed</Text>
                      </View>
                    </View>
                    <View style={[styles.formCheckGroupDiv]}>
                      <View style={[styles.formGroupSimple, styles.checkBoxDiv,]}>
                        ...
                        <Text style={styles.checkBoxTitle}>Disabled</Text>
                      </View>
                    </View>
                  </View>
                  <View style={styles.formGroupDiv}>
