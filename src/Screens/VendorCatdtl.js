...
const VendorCatdtl = (props) => {
  const handleClick = () => {
    // props.history.push("/VendorCat");
    props.navigation.navigate('VendorCat');
  }
  const handleClick2 = () => {
    // props.history.push("/VendorCatedt");
    props.navigation.navigate('VendorCatedt');
  }
  return (
    <View style={{ flex: 1, backgroundColor: '#ffffff' }}>
      ...
      <View style={styles.mainHeaderOuter}>
        <LinearGradient
          ...
          <Text style={styles.headerTitle}>Vendor's Category Details</Text>
            ...
            <View style={[styles.centerBoxNo, styles.whiteBoxContainer]}>
              <View style={[styles.formGroupDiv, styles.formGroupBorderDiv]}>
                <View style={[styles.formGroupNew, styles.formGroupSimple]}>
                  <Text style={[styles.formLabelNew, styles.noAbsolute]}>Category Name</Text>
              ...
              <View style={[styles.formGroupDiv,]}>
                <View style={[styles.formGroupNew, styles.formGroupSimple]}>
                  ...
                  <Text style={[styles.customTabText]}>It is a long established fact that a reader will be
                    distracted by the readable content of a page when looking at its layout. </Text>
                </View>
              </View>
            </View>
          </View>
