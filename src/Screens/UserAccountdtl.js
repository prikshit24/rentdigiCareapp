...
const UserAccountdtl = (props) => {
  const handleClick = () => {
    // props.history.push("/UserAccount");
    props.navigation.navigate('UserAccount');
  }
  const handleClick2 = () => {
    // props.history.push("/UserAccountedt");
    props.navigation.navigate('UserAccountedt');
  }
  return (
            ...
            <View style={[styles.centerBoxNo, styles.whiteBoxContainer]}>
              <View style={[styles.formGroupDiv, styles.formGroupBorderDiv]}>
                <View style={[styles.formGroupNew, styles.formGroupSimple]}>
                  <Text style={[styles.formLabelNew, styles.noAbsolute]}>Username</Text>
                  <Text style={[styles.customTabText]}>danishsharma88</Text>
                </View>
                <View style={[styles.formGroupNew, styles.formGroupSimple]}>
                  <Text style={[styles.formLabelNew, styles.noAbsolute]}>Password</Text>
                  <Text style={[styles.customTabText]}>..........</Text>
                </View>
              </View>
              <View style={[styles.formGroupDiv, styles.formGroupBorderDiv]}>
                <View style={[styles.formGroupNew, styles.formGroupSimple]}>
                  <Text style={[styles.formLabelNew, styles.noAbsolute]}>First Name</Text>
                  <Text style={[styles.customTabText]}>Danish</Text>
                </View>
                <View style={[styles.formGroupNew, styles.formGroupSimple]}>
                  <Text style={[styles.formLabelNew, styles.noAbsolute]}>Last Name</Text>
                  <Text style={[styles.customTabText]}>Sharma</Text>
                </View>
              </View>
              <View style={[styles.formGroupDiv, styles.formGroupBorderDiv]}>
                <View style={[styles.formGroupNew, styles.formGroupSimple]}>
                ...
                <View style={[styles.formGroupNew, styles.formGroupSimple]}>
                  <Text style={[styles.formLabelNew, styles.noAbsolute]}>Time Zone</Text>
                  <Text style={[styles.customTabText]}>US</Text>
                </View>
              </View>
              <View style={[styles.formGroupDiv, styles.formGroupBorderDiv]}>
                <View style={[styles.formGroupNew, styles.formGroupSimple]}>
                  <Text style={[styles.formLabelNew, styles.noAbsolute]}>Confirmed</Text>
                  <Text style={[styles.customTabText]}>Yes</Text>
                </View>
                <View style={[styles.formGroupNew, styles.formGroupSimple]}>
                  <Text style={[styles.formLabelNew, styles.noAbsolute]}>Disabled</Text>
                  <Text style={[styles.customTabText]}>Yes</Text>
                </View>
              </View>
              <View style={[styles.formGroupDiv, styles.formGroupBorderDiv]}>
                <View style={[styles.formGroupNew, styles.formGroupSimple]}>
                  <Text style={[styles.formLabelNew, styles.noAbsolute]}>Assign Manager</Text>
              ...
              <View style={[styles.formGroupDiv]}>
                <View style={[styles.formGroupNew, styles.formGroupSimple]}>
                  <Text style={[styles.formLabelNew, styles.noAbsolute]}>Period</Text>
                  <Text style={[styles.customTabText]}>One</Text>
                </View>
                <View style={[styles.formGroupNew, styles.formGroupSimple]}>
                  <Text style={[styles.formLabelNew, styles.noAbsolute]}>Escalation Email</Text>
                  <Text style={[styles.customTabText]}>abc@gmail.com</Text>
                </View>
              </View>
            </View>
