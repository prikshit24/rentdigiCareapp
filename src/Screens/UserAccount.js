...
const UserAccount = (props) => {
  const addCardClick = () => {
    // props.history.push("/UserAccountadd");
    props.navigation.navigate('UserAccountadd');
  }
  const UserAccountdtl = () => {
    // props.history.push("/UserAccountdtl");
    props.navigation.navigate('UserAccountdtl')
  }
              ...
              <View style={[styles.columnTwo]}>
                ...
                <View style={[styles.mainHdngBtm, styles.mt10]} >
                  <Text style={styles.textBlue} >
                    <Text style={[styles.mainTitle, styles.greyText,]}>User Account</Text> (3)
                  </Text>
                </View>
              </View>
            </View>
            <View style={[styles.prpertyList]}>
              <TouchableOpacity style={styles.proprtyCardItem} backgroundColor={'#ffffff'} onPress={UserAccountdtl}>
                <View style={styles.proprtyCardCol}>
                  <View style={styles.proprtyCardRow}>
                    <View style={[styles.proprtyCardRight]}>
                      <Text style={[styles.mediumTitle, styles.pt8, styles.textBlue,]}>Danish Sharma</Text>
              ...
              <TouchableOpacity style={styles.proprtyCardItem} backgroundColor={'#ffffff'} onPress={UserAccountdtl}>
                <View style={styles.proprtyCardCol}>
                  <View style={styles.proprtyCardRow}>
                    <View style={[styles.proprtyCardRight]}>
                      <Text style={[styles.mediumTitle, styles.pt8, styles.textBlue,]}>John Doe</Text>
                      <Text style={[styles.locatnTextBig, styles.py7]}>
                        confirmed</Text>
                      <View style={[styles.spaceBetween, styles.pb10,]}>
                        <Text style={[styles.prptyFtrIcon]}>
              ...
              <TouchableOpacity style={styles.proprtyCardItem} backgroundColor={'#ffffff'} onPress={UserAccountdtl}>
                <View style={styles.proprtyCardCol}>
                  <View style={styles.proprtyCardRow}>
                    <View style={[styles.proprtyCardRight]}>
                      <Text style={[styles.mediumTitle, styles.pt8, styles.textBlue,]}>Doe John</Text>
                      <Text style={[styles.locatnTextBig, styles.py7]}>
                        confirmed</Text>
                      <View style={[styles.spaceBetween, styles.pb10,]}>
                        <Text style={[styles.prptyFtrIcon]}>
