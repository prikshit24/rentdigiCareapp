...
const VendorCat = (props) => {

  const [password, onChangeText2] = React.useState("");
  const addCardClick = () => {
    // props.history.push("/VendorCatadd");
    props.navigation.navigate('VendorCatadd');
  }
  const VendorCatdtl = () => {
    // props.history.push("/VendorCatdtl");
    props.navigation.navigate('VendorCatdtl');
  }
    ...
    <View style={{ flex: 1, backgroundColor: '#ffffff' }}>
      ...
      {/* <View style={styles.mainHeaderOuter}>
        <LinearGradient
          ...
          <Text style={styles.headerTitle}>Vendor's Category</Text>
        </LinearGradient>
      </View> */}
              ...
              <View style={[styles.columnTwo]}>
                ...
                <View style={[styles.mainHdngBtm, styles.mt10]} >
                  <Text style={styles.textBlue} >
                    <Text style={[styles.mainTitle, styles.greyText,]}>Vendor's Category</Text> (6)
                  </Text>
                </View>
              </View>
            </View>
            <View style={[styles.prpertyList]}>
              <TouchableOpacity style={styles.proprtyCardItem} backgroundColor={'#ffffff'} onPress={VendorCatdtl}>
                <View style={styles.proprtyCardCol}>
                  <View style={styles.proprtyCardRow}>
                    <View style={[styles.proprtyCardRight]}>
                      <Text style={[styles.mediumTitle, styles.pt8, styles.textBlue,]}>Painting</Text>
                      <Text style={[styles.locatnTextBig, styles.py7]}>
                        It is a long established fact that a reader. </Text>
