...
const Preview = (props) => {
  ...
  const paymentCardsClick = () => {
    // props.history.push("/paymentcards");
            ...
            <View style={[styles.centerBoxNo, styles.btnFixContainer]}>
              <View style={styles.customTabsDiv}>
                ...
                <View style={styles.customTabs}>
                  <TouchableOpacity style={styles.customTabCol} onPress={locationClick}>
                    <Text style={[styles.customTabCount]}>1</Text>
                  ...
                  <TouchableOpacity style={styles.customTabCol} onPress={previewClick}>
                    <Text style={[styles.customTabCount, styles.customTabCountFill]}>4</Text>
                    <Text style={[styles.customTabText]}>Preview</Text>
                  </TouchableOpacity>
                </View>
              </View>
              <View style={styles.formTitleDiv}>
                <Text style={styles.formTitleText}>Shipment Details</Text>
              ...
              <View style={[styles.formGroupDiv, styles.formGroupBorderDiv]}>
                <View style={[styles.formGroupNew, styles.formGroupSimple]}>
                  ...
                  <Text style={[styles.customTabText]}>934 Colin Gateway Suite 973</Text>
                </View>
                <View style={[styles.formGroupNew, styles.formGroupSimple]}>
                  <Text style={[styles.formLabelNew, styles.noAbsolute]}>City/State/Zipcode</Text>
                  <Text style={[styles.customTabText]}>Chicago,Illionis, 60402</Text>
                </View>
              </View>
              <View style={[styles.formGroupDiv, styles.formGroupBorderDiv]}>
                <View style={[styles.formGroupNew, styles.formGroupSimple]}>
                  <Text style={[styles.formLabelNew, styles.noAbsolute]}>Drop Off Address</Text>
                  <Text style={[styles.customTabText]}>934 Colin Gateway Suite 973</Text>
                </View>
                <View style={[styles.formGroupNew, styles.formGroupSimple]}>
                  <Text style={[styles.formLabelNew, styles.noAbsolute]}>City/State/Zipcode</Text>
              ...
              <View style={[styles.formGroupDiv, styles.formGroupBorderDiv]}>
                <View style={[styles.formGroupNew, styles.formGroupSimple]}>
                  <Text style={[styles.formLabelNew, styles.noAbsolute]}>Product Name</Text>
                  <Text style={[styles.customTabText]}>934 Colin Gateway Suite 973</Text>
                </View>
                <View style={[styles.formGroupNew, styles.formGroupSimple]}>
                  <Text style={[styles.formLabelNew, styles.noAbsolute]}>Shipment ID</Text>
                  <Text style={[styles.customTabText]}>Chicago,Illionis, 60402</Text>
                </View>
              </View>
              <View style={[styles.formGroupDiv, styles.formGroupBorderDiv]}>
                <View style={[styles.formGroupNew, styles.formGroupSimple]}>
                  <Text style={[styles.formLabelNew, styles.noAbsolute]}>Weight & Dimension</Text>
                  <Text style={[styles.customTabText]}>934 Colin Gateway Suite 973</Text>
                </View>
                <View style={[styles.formGroupNew, styles.formGroupSimple]}>
                  <Text style={[styles.formLabelNew, styles.noAbsolute]}>Payment Type</Text>
                  <Text style={[styles.customTabText]}>Chicago,Illionis, 60402</Text>
                </View>
              </View>
              <View style={styles.formGroupDiv}>
                <View style={[styles.formGroupNew, styles.formGroupSimple]}>
                  ...
                  <Text style={[styles.customTabText]}>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt</Text>
                </View>
              </View>
            </View>
          </View>
      ...
      <View style={styles.fixBtnDiv}>
        <View style={styles.innerFlex}>
          <View style={styles.amtDiv}>
            <Text style={styles.amtTextLabel}>Estimation Cost</Text>
            <Text style={styles.amtText}>$150</Text>
          </View>
        </View>
        <View style={styles.innerFlex}>
          <TouchableOpacity style={styles.btnGradientDiv} onPress={paymentCardsClick}>
            <LinearGradient
              start={{ x: 0, y: 0 }} end={{ x: 1, y: 0 }}
              colors={['#0e558d', '#084677']}
