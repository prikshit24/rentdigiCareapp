...
const RoomsDtl = (props) => {
  const handleClick = () => {
    // props.history.push("/rooms");
    props.navigation.navigate('rooms')
  }
  const handleClick2 = () => {
    // props.history.push("/roomsEdt");
    props.navigation.navigate('roomsEdt')
  }
  const trackClick = () => {
    // props.history.push("/trackPackage");
    props.navigation.navigate('trackPackage')
  }
  return (
            ...
            <View style={[styles.centerBoxNo, styles.whiteBoxContainer]}>
              <View style={[styles.formGroupDiv, styles.formGroupBorderDiv]}>
                <View style={[styles.formGroupNew, styles.formGroupSimple]}>
                  ...
                  <Text style={[styles.customTabText]}>PLUMB</Text>
                </View>
                <View style={[styles.formGroupNew, styles.formGroupSimple]}>
                  <Text style={[styles.formLabelNew, styles.noAbsolute]}>Area</Text>
                  <Text style={[styles.customTabText]}>1071</Text>
                </View>
              </View>
              <View style={[styles.formGroupDiv, styles.formGroupBorderDiv]}>
                <View style={[styles.formGroupNew, styles.formGroupSimple]}>
                  <Text style={[styles.formLabelNew, styles.noAbsolute]}>Room</Text>
                  <Text style={[styles.customTabText]}>213</Text>
                </View>
                <View style={[styles.formGroupNew, styles.formGroupSimple]}>
                  <Text style={[styles.formLabelNew, styles.noAbsolute]}>Contact</Text>
                  <Text style={[styles.customTabText]}>water</Text>
                </View>
              </View>
              <View style={[styles.formGroupDiv, styles.formGroupBorderDiv]}>
                <View style={[styles.formGroupNew, styles.formGroupSimple]}>
                  <Text style={[styles.formLabelNew, styles.noAbsolute]}>Created</Text>
                  <Text style={[styles.customTabText]}>18/01/2022</Text>
                </View>
                <View style={[styles.formGroupNew, styles.formGroupSimple]}>
                  <Text style={[styles.formLabelNew, styles.noAbsolute]}>Active</Text>
                  <Text style={[styles.customTabText]}>	Closed</Text>
                </View>
              </View>

              <View style={styles.formGroup}>
                <Text style={[styles.formLabelDark, styles.textBold]}>Attachment</Text>
