...
const MaintenanceRequestDtls = props => {
    ...
    <View style={{flex: 1, backgroundColor: '#ffffff'}}>
      ...
      <View>
        <LinearGradient
          ...
          <Text style={styles.headerTitle}>Maintenance Request Details</Text>
        </LinearGradient>
      </View>
              ...
              <View style={{marginTop: 15, marginHorizontal: '4%'}}>
                <View style={{marginTop: 15}}>
                  <View
                    ...
                    <Text style={[styles.headingTextStyle]}>Ticket Detail</Text>
                    <Text style={[styles.headingTextStyle]}>Assign</Text>
                  </View>
...
export default MaintenanceRequestDtls;
