...
const AssetClassdtl = (props) => {
  const handleClick = () => {
    // props.history.push("/AssetClass");
    props.navigation.navigate('AssetClass')
  }
  const handleClick2 = () => {
    // props.history.push("/AssetClassedit");
    props.navigation.navigate('AssetClassedit')
  }
  return (
    <View style={{ flex: 1, backgroundColor: '#ffffff' }}>
      ...
      <View style={styles.mainHeaderOuter}>
        <LinearGradient
          ...
          <Text style={styles.headerTitle}>Asset Class Details</Text>
