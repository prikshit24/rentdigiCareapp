...
const CompanyProfile = (props) => {
  const [companyName, onChangeText] = React.useState("");
  const [Emails, onChangeText92] = React.useState("");
  const [fax, onChangeText91] = React.useState("");
  ...
  const [Telephone2, onChangeText90] = React.useState("");
            ...
            <View style={styles.mainBody}>
              <View style={styles.centerBoxNo}>
                ...
                <View style={styles.formOuter}>
                  ...
                  <View style={styles.formGroupDiv}>
                    <View style={styles.formGroupNew}>
                      <Text style={styles.formLabelNew}>Business Email</Text>
                      <TextInput
                        style={styles.formControlNew}
                        value={Emails}
                        onChangeText={onChangeText92}
                        placeholder=""
                        placeholderTextColor="#fbfbfb"
                      />
                    </View>
