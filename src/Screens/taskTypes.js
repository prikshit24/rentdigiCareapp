...
const TaskTypes = (props) => {
  const addCardClick = () => {
    ...
    props.navigation.navigate('taskAdd')
  }
  const TaskDtl = () => {
    ...
    <View style={{ flex: 1, backgroundColor: '#ffffff' }}>
      ...
      {/* <View style={styles.mainHeaderOuter}>
        <LinearGradient
          ...
          <Text style={styles.headerTitle}>Task Types</Text>
        </LinearGradient>
      </View> */}
              ...
              <View style={[styles.columnTwo]}>
                <View style={[styles.mainHdngBtm, styles.mt10]} >
                  <Text style={styles.textBlue} >
                    <Text style={[styles.mainTitle, styles.greyText,]}>Task Types</Text> (6)
                  </Text>
                </View>
              </View>
            </View>
            <View style={[styles.prpertyList]}>
              <TouchableOpacity style={styles.proprtyCardItem} backgroundColor={'#ffffff'} onPress={TaskDtl}>
                <View style={styles.proprtyCardCol}>
                  <View style={styles.proprtyCardRow}>
                    <View style={[styles.proprtyCardRight]}>
                      <Text style={[styles.mediumTitle, styles.pt8, styles.textBlue,]}>Rentdigi/GSK</Text>
