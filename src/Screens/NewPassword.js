...
const NewPassword = (props) => {
  ...
  return (
    <ScrollView contentContainerStyle={styles.outerContainer}>
      ...
      <ImageBackground style={styles.bgImage} source={require('../assets/img/loginBg.jpg')} >
        ...
        <View style={styles.loginOuter}>
          <View style={styles.loginCenterDiv}>
            <View style={styles.loginTextDiv}>
              <Image source={require('../assets/img/logo.png')} style={styles.mainLogo} />
              <Text style={styles.mainTitle}>Reset Password</Text>
              <Text style={styles.subTitle}>Please fill the details below to reset your password</Text>
            </View>
