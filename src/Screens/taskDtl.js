...
const TaskDtl = (props) => {
  const handleClick = () => {
    // props.history.push("/taskTypes");
    props.navigation.navigate('taskTypes')
  }
  const handleClick2 = () => {
    // props.history.push("/taskEdt");
    props.navigation.navigate('taskEdt')
  }
  return (
    <View style={{ flex: 1, backgroundColor: '#ffffff' }}>
      ...
      <View style={styles.mainHeaderOuter}>
        <LinearGradient
          ...
          <Text style={styles.headerTitle}>Task Types Details</Text>
            ...
            <View style={[styles.centerBoxNo, styles.whiteBoxContainer]}>
              <View style={[styles.formGroupDiv, styles.formGroupBorderDiv]}>
                <View style={[styles.formGroupNew, styles.formGroupSimple]}>
                  <Text style={[styles.formLabelNew, styles.noAbsolute]}>Type Code</Text>
                  <Text style={[styles.customTabText]}>1234</Text>
                </View>
                <View style={[styles.formGroupNew, styles.formGroupSimple]}>
              ...
              <View style={[styles.formGroupDiv, styles.formGroupBorderDiv]}>
                <View style={[styles.formGroupNew, styles.formGroupSimple]}>
                  <Text style={[styles.formLabelNew, styles.noAbsolute]}>Contact Email</Text>
              ...
              <View style={[styles.formGroupDiv, styles.formGroupBorderDiv]}>
                <View style={[styles.formGroupNew, styles.formGroupSimple]}>
                  <Text style={[styles.formLabelNew, styles.noAbsolute]}>Provider</Text>
                  <Text style={[styles.customTabText]}>one</Text>
                </View>
                <View style={[styles.formGroupNew, styles.formGroupSimple]}>
                  <Text style={[styles.formLabelNew, styles.noAbsolute]}>Cell #</Text>
                  <Text style={[styles.customTabText]}>12345</Text>
                </View>
              </View>
              <View style={[styles.formGroupDiv, styles.formGroupBorderDiv]}>
                <View style={[styles.formGroupNew, styles.formGroupSimple]}>
                  <Text style={[styles.formLabelNew, styles.noAbsolute]}>Web Enable</Text>
                  <Text style={[styles.customTabText]}>Yes</Text>
                </View>
                <View style={[styles.formGroupNew, styles.formGroupSimple]}>
                  <Text style={[styles.formLabelNew, styles.noAbsolute]}>Cell Notification</Text>
                  <Text style={[styles.customTabText]}>Yes</Text>
                </View>
              </View>
              <View style={[styles.formGroupDiv, styles.formGroupBorderDiv]}>
