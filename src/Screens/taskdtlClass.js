...
const TaskdtlClass = (props) => {
  const handleClick = () => {
    // props.history.push("/taskClass");
    props.navigation.navigate('taskClass')
  }
  const handleClick2 = () => {
    // props.history.push("/taskclassEdt");
    props.navigation.navigate('taskclassEdt')
  }
  return (
    <View style={{ flex: 1, backgroundColor: '#ffffff' }}>
      ...
      <View style={styles.mainHeaderOuter}>
        <LinearGradient
          ...
          <Text style={styles.headerTitle}>Task Class Details</Text>
            ...
            <View style={[styles.centerBoxNo, styles.whiteBoxContainer]}>
              <View style={[styles.formGroupDiv, styles.formGroupBorderDiv]}>
                <View style={[styles.formGroupNew, styles.formGroupSimple]}>
                  <Text style={[styles.formLabelNew, styles.noAbsolute]}>Class Code</Text>
