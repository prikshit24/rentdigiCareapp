...
const BuildingArea = (props) => {
  ...
  const addCardClick = () => {
    // props.history.push("/buildingAdd");
    props.navigation.navigate('buildingAdd')
  }
  const BuildingDtl = () => {
    // props.history.push("/buildingDtl");
    props.navigation.navigate('buildingDtl')
  }
              ...
              <View style={[styles.columnTwo]}>
                ...
                <View style={[styles.mainHdngBtm, styles.mt10]} >
                  <Text style={styles.textBlue} >
                    <Text style={[styles.mainTitle, styles.greyText,]}>Building Area</Text> (6)
                  </Text>
                </View>
              </View>
            </View>
            <View style={[styles.prpertyList]}>
              <TouchableOpacity style={styles.proprtyCardItem} backgroundColor={'#ffffff'} onPress={BuildingDtl}>
                <View style={styles.proprtyCardCol}>
                  <View style={styles.proprtyCardRow}>
                    <View style={[styles.proprtyCardRight]}>
                      <Text style={[styles.mediumTitle, styles.pt8, styles.textBlue]}>GSK</Text>
              ...
              <TouchableOpacity style={styles.proprtyCardItem} backgroundColor={'#ffffff'} onPress={BuildingDtl}>
                <View style={styles.proprtyCardCol}>
                  <View style={styles.proprtyCardRow}>
                    <View style={[styles.proprtyCardRight]}>
                      <Text style={[styles.mediumTitle, styles.pt8, styles.textBlue]}>Rentdigi</Text>
                      <Text style={[styles.locatnTextBig, styles.py7]}>
                        1073363</Text>
                      <View style={[styles.spaceBetween, styles.pb10,]}>
                        <Text style={[styles.prptyFtrIcon]}>
              ...
              <TouchableOpacity style={styles.proprtyCardItem} backgroundColor={'#ffffff'} onPress={BuildingDtl}>
                <View style={styles.proprtyCardCol}>
                  <View style={styles.proprtyCardRow}>
                    <View style={[styles.proprtyCardRight]}>
                      <Text style={[styles.mediumTitle, styles.pt8, styles.textBlue]}>Chappelle Garden Villas</Text>
                      <Text style={[styles.locatnTextBig, styles.py7]}>
                        1073363</Text>
                      <View style={[styles.spaceBetween, styles.pb10,]}>
                        <Text style={[styles.prptyFtrIcon]}>
              ...
              <TouchableOpacity style={styles.proprtyCardItem} backgroundColor={'#ffffff'} onPress={BuildingDtl}>
                <View style={styles.proprtyCardCol}>
                  <View style={styles.proprtyCardRow}>
                    <View style={[styles.proprtyCardRight]}>
                      <Text style={[styles.mediumTitle, styles.pt8, styles.textBlue]}>Oak Tower</Text>
                      <Text style={[styles.locatnTextBig, styles.py7]}>
                        1073363</Text>
                      <View style={[styles.spaceBetween, styles.pb10,]}>
                        <Text style={[styles.prptyFtrIcon]}>
              ...
              <TouchableOpacity style={styles.proprtyCardItem} backgroundColor={'#ffffff'} onPress={BuildingDtl}>
                <View style={styles.proprtyCardCol}>
                  <View style={styles.proprtyCardRow}>
                    <View style={[styles.proprtyCardRight]}>
                      <Text style={[styles.mediumTitle, styles.pt8, styles.textBlue]}>Chappelle Garden</Text>
                      <Text style={[styles.locatnTextBig, styles.py7]}>
                        1073363</Text>
                      <View style={[styles.spaceBetween, styles.pb10,]}>
                        <Text style={[styles.prptyFtrIcon]}>
              ...
              <TouchableOpacity style={styles.proprtyCardItem} backgroundColor={'#ffffff'} onPress={BuildingDtl}>
                <View style={styles.proprtyCardCol}>
                  <View style={styles.proprtyCardRow}>
                    <View style={[styles.proprtyCardRight]}>
                      <Text style={[styles.mediumTitle, styles.pt8, styles.textBlue]}>Riverside Villas</Text>
                      <Text style={[styles.locatnTextBig, styles.py7]}>
                        1073363</Text>
                      <View style={[styles.spaceBetween, styles.pb10,]}>
                        <Text style={[styles.prptyFtrIcon]}>
