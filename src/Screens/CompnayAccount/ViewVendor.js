...
const ViewVendors = props => {
  ...
  const addCardClick = () => {
    props.navigation.navigate('Vendoradd');
  };

  const handleViewDetails = () => {
    props.navigation.navigate('viewVendorDtls');
  };
        ...
        <View style={styles.mainBoxOuter}>
          <View style={styles.fixInfoDiv}>
            <View
              ...
              <Text style={[styles.mainTitle, styles.txtStyle]}>Vendors</Text>
            </View>
            <View
              style={[
                styles.mt10,
                ...
                <View style={{marginTop: 15}}>
                  ...
                  <View style={{marginTop: 10}}>
                    <TextInput
                      ...
                      onChangeText={suiteFilter => setSuiteFilter(suiteFilter)}
                      value={suiteFilter}
                      placeholder="Enter contact vendor number"
                      placeholderTextColor="#707070"
                    />
                  </View>
                </View>
                <View style={{marginTop: 15}}>
                  ...
                  <View style={{marginTop: 10}}>
                    <TextInput
                      ...
                      onChangeText={suiteFilter => setSuiteFilter(suiteFilter)}
                      value={suiteFilter}
                      placeholder="Enter a Vendor city"
                      placeholderTextColor="#707070"
                    />
                  </View>
                </View>
