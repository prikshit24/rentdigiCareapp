...
const AddVendor = props => {
  ...
  const handleClick = () => {
    props.navigation.navigate('viewVendor');
  };
  return (
            ...
            <View style={styles.mainBody}>
              <View>
                <View style={styles.formOuter}>
                  ...
                  <View style={{marginTop: 2}}>
                    <Text style={[styles.txtInputStyle]}>Contact Number</Text>
                    <View style={{marginTop: 10}}>
                      <TextInput
                        style={styles.formControlNew}
                        onChangeText={value => {
                  ...
                  <View style={{marginTop: 2}}>
                    <Text style={[styles.txtInputStyle]}>Agency Name</Text>
                    <View style={{marginTop: 10}}>
                      <TextInput
                        style={styles.formControlNew}
                        onChangeText={value => {
                  ...
                  <View style={{marginTop: 10}}>
                    <Text style={styles.filtertxtStyle}>Companies*</Text>
                    <View style={{marginTop: 10}}>
                      <Dropdown
                  ...
                  <View style={{marginTop: 12}}>
                    <Text style={[styles.txtInputStyle]}>Address</Text>
                    <View style={{marginTop: 10}}>
                      <TextInput
                  ...
                  <View style={{marginTop: 12}}>
                    <Text style={[styles.txtInputStyle]}>Profile Picture</Text>
