...
const EditSpecialities = props => {
  const [editSpecialities, setEditSpecialities] = useState('');

  const handleClick = () => {
    props.navigation.navigate('addSpecialities');
  };
    ...
    <View style={{flex: 1, backgroundColor: '#ffffff'}}>
      ...
      <View>
        <LinearGradient
          ...
          <Text style={styles.headerTitle}>Edit Speciality</Text>
        </LinearGradient>
      </View>
              ...
              <View>
                <View>
                  <View style={{marginTop: 2}}>
                    <Text style={[styles.txtInputStyle]}>Speciality*</Text>
                    <View style={{marginTop: 10}}>
                      <TextInput
                        style={styles.formControlNew}
                        onChangeText={editSpecialities => setEditSpecialities(editSpecialities)}
