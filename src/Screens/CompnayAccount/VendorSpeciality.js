...
const VendorSpeciality = props => {
  const addCardClick = () => {
    props.navigation.navigate('addVendorSpeciality');
  };
  const editProperty = () => {
    props.navigation.navigate('editVendorSpeciality');
  };
          ...
          <View style={styles.fixInfoDiv}>
            <View
              ...
              <View style={{marginTop: 10}}>
                ...
                />
                <Feather name={'search'} color={'#707070'} size={20} style = {{position:'absolute',top:15,left:12}} />
              </View>
            </View>
...
export default VendorSpeciality;
