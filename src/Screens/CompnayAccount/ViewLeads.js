...
const ViewLeads = props => {
  ...
  const [leadesFilter, setLeadesFilter] = useState({
    name: '', phone: '', email: '', propertyName: '', bedroomType: '', apartment: '', status: '', requestType: ''
  })

  const [isLoading, setLoading] = useState(false);
  const [leadesList, setLeadesList] = useState([]);
  const [leasesFilterList, setLeadesFilterList] = useState([]);
  ...
  const searchApplicant = async () => {
    setPage(1);
    setLeadesList([]);
    if (leadesFilter.apartment || leadesFilter.bedroomType || startDateSelected || endDateSelected || leadesFilter.email || leadesFilter.name || leadesFilter.phone || leadesFilter.propertyName || leadesFilter.requestType || leadesFilter.status) {
      // setLimit(10);
  ...
  const getLeades = async (page, limit, data, filter) => {
    ...
    setLoading(true)
    if (filter == "filter") {
      postData(`${api.GET_LEADES_COMPANY}?page=${page}&limit=${limit}`, filterData, "").then((res) => {
        if (res.data.status == 200) {
          setLoading(false);
          setLeadesList((prev) => ([...prev, ...res.data.results.applications]));
      ...
      postData(`${api.GET_LEADES_COMPANY}?page=${page}&limit=${limit}`, "", "").then((res) => {
        if (res.data.status == 200) {
          setLoading(false);
          setLeadesList((prev) => ([...prev, ...res.data.results.applications]));
          setTotalCount(res.data.total && res.data.total.Total)
  ...
  const handleViewDetails = () => {
    props.navigation.navigate('leadsDetails');
  };
        ...
        <View style={styles.mainBoxOuter}>
          <View style={styles.fixInfoDiv}>
            <View
              ...
              <Text style={[styles.mainTitle, styles.greyText]}>Total(0)</Text>
              ...
              <View style={{ marginTop: 15, marginHorizontal: '4%' }}>
                <View style={{ marginTop: 15 }}>
                  ...
                  <View style={{ marginTop: 10 }}>
                    <TextInput
                      ...
                      onChangeText={val => setLeadesFilter({ ...leadesFilter, name: val })}
                      value={leadesFilter.name}
                ...
                <View style={{ marginTop: 15 }}>
                  ...
                  <View style={{ marginTop: 10 }}>
                    <TextInput
                      style={styles.formControlNew}
                      onChangeText={val => setLeadesFilter({ ...leadesFilter, phone: val })}
                      value={leadesFilter.phone}
                ...
                <View style={{ marginTop: 15 }}>
                  ...
                  <View style={{ marginTop: 10 }}>
                    <TextInput
                      style={styles.formControlNew}
                      onChangeText={val => setLeadesFilter({ ...leadesFilter, email: val })}
                      value={leadesFilter.email}
                ...
                <View style={{ marginTop: 15 }}>
                  ...
                  <View style={{ marginTop: 10 }}>
                    <TextInput
                      style={styles.formControlNew}
                      onChangeText={val => setLeadesFilter({ ...leadesFilter, propertyName: val })}
                      value={leadesFilter.propertyName}
                ...
                <View style={{ marginTop: '5%' }}>
                  ...
                  <View style={{ marginTop: 10 }}>
                    <Dropdown
                      ...
                      labelField="label"
                      valueField="value"
                      value={leadesFilter.bedroomType}
                      onChange={item => {
                        setLeadesFilter({ ...leadesFilter, bedroomType: item.value });
                      }}
                    />
                  </View>
                </View>
                <View style={{ marginTop: '5%' }}>
                  ...
                  <View style={{ marginTop: 10 }}>
                    <Dropdown
                      ...
                      labelField="label"
                      valueField="value"
                      value={leadesFilter.apartment}
                      onChange={item => {
                        setLeadesFilter({ ...leadesFilter, apartment: item.value });
                      }}
                    />
                  </View>
                </View>
                <View style={{ marginTop: '5%' }}>
                  ...
                  <View style={{ marginTop: 10 }}>
                    <Dropdown
                      ...
                      labelField="label"
                      valueField="value"
                      value={leadesFilter.status}
                      onChange={item => {
                        setLeadesFilter({ ...leadesFilter, status: item.value });
                      }}
                    />
                  </View>
                </View>
                <View style={{ marginTop: '5%' }}>
                  ...
                  <View style={{ marginTop: 10 }}>
                    <Dropdown
                      ...
                      labelField="label"
                      valueField="value"
                      value={leadesFilter.requestType}
                      onChange={item => {
                        setLeadesFilter({ ...leadesFilter, requestType: item.value });
                      }}
                    />
                  </View>
                </View>
