...
const TicketApprove = props => {
  ...
  const handleBack = () => {
    props.navigation.navigate('viewRequestDtls');
  };

  const handleViewDetails = () =>{
    props.navigation.navigate('ticketApprveDtls');
    ...
    <View style={{flex: 1, backgroundColor: '#ffffff'}}>
      ...
      <View>
        <LinearGradient
          ...
          <Text style={styles.headerTitle}>Approve Quoted Ticket</Text>
        </LinearGradient>
      </View>
