...
const AddSpecialities = props => {
  const addCardClick = () => {
    props.navigation.navigate('aadSpeciality');
  };

  const editProperty = () =>{
    props.navigation.navigate('editSpecialities');
  }
        ...
        <View style={styles.mainBoxOuter}>
          <View style={styles.fixInfoDiv}>
            <View
              ...
              <Text style={[styles.mainTitle, styles.greyText]}>Total(3)</Text>
            </View>
