...
const PropertyManagerData = [
  {
    ...
    email: 'demopm2@yopmail.com	',
    mobile: '9816922898	',
    createdBy: '2023-02-14',
    Docs: 'NA',
    Status: 'Active',
    properties: '1',
  },
  ...
  {
    Manager: 'Md Azim',
    email: 'azim@yopmail.com	',
    mobile: '8712445786',
    createdBy: '2023-02-06',
    Docs: 'NA',
    Status: 'Active',
    properties: '1',
  },
  {
    Manager: 'Pankaj Manager',
    email: 'demopm1@yopmail.com',
    mobile: '8253434044	',
    createdBy: '2023-02-24',
    Docs: 'NA',
    Status: 'Active',
    properties: '1',
  },
...
const PropertyManager = props => {
  ...
  const addCardClick = () => {
    props.navigation.navigate('managerAdd');
  };

  const handleViewDetails = () => {
    props.navigation.navigate('propertyManrDtls');
  };
  const editProperty = () => {
        ...
        <View style={styles.mainBoxOuter}>
          <View style={styles.fixInfoDiv}>
            ...
            <View
              ...
              <Text style={[styles.mainTitle, styles.greyText]}>Total(4)</Text>
            </View>
                ...
                <View style={{marginTop: 15}}>
                  ...
                  <View style={{marginTop: 10}}>
                    <TextInput
                      ...
                      value={propertyManagerFilter.propertyID}
