...
const RoomsAdd = (props) => {
  const [roomNo, onChangeText] = React.useState("");
  const [notes, onChangeText9] = React.useState("");
  const [roomLabel, onChangeText1] = React.useState("");
  const [contactname, onChangeText2] = React.useState("");
  const [contactEmail, onChangeText3] = React.useState("");
  const [contactPhone, onChangeText4] = React.useState("");
    ...
    <View style={{ flex: 1, backgroundColor: '#ffffff' }}>
      ...
      <View style={styles.mainHeaderOuter}>
        <LinearGradient
          ...
          <Text style={styles.headerTitle}>Rooms Details Add</Text>
        </LinearGradient>
      </View>
                ...
                <View style={styles.formOuter}>
                  <View style={styles.formGroupDiv}>
                    <View style={styles.formGroupNew}>
                      <Text style={styles.formLabelNew}>Room#</Text>
                      <TextInput
                  ...
                  <View style={styles.formGroupDiv}>
                    <View style={styles.formGroupNew}>
                      <Text style={styles.formLabelNew}>Room Label</Text>
                      <TextInput
                        style={styles.formControlNew}
                        value={roomLabel}
                  ...
                  <View style={styles.formGroupDiv}>
                    <View style={styles.formGroupNew}>
                      <Text style={styles.formLabelNew}>Floor</Text>
                      <View style={styles.selectDrop}>
                        <Dropdown
                  ...
                  <View style={styles.formGroupDiv}>
                    <View style={styles.formGroupNew}>
                      <Text style={styles.formLabelNew}>Contact Name</Text>
                      <TextInput
                        style={styles.formControlNew}
                        value={contactname}
                  ...
                  <View style={styles.formGroupDiv}>
                    <View style={styles.formGroupNew}>
                      <Text style={styles.formLabelNew}>Contact Phone</Text>
                      <TextInput
                        style={styles.formControlNew}
                        value={contactPhone}
                  ...
                  <View style={styles.formGroupDivv}>
                    <View style={styles.formGroup}>
                      <View style={styles.uploadIdDiv}>
                        ...
                        <Text style={styles.uploadIdTitle}>Documents</Text>
                      </View>
                    </View>
                  </View>
