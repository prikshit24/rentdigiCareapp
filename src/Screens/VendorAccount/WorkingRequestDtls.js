...
const Data = [
  {
    ...
    Details: 'sdfsd',
    Action: 'Quoted	',
    From: '02/23/2023 19:43',
    To: '02/23/2023 22:45',
    Status: 'Open',
  },
];

const WorkingRequestDtls = props => {
  const [visible, setVisible] = useState(false);
  const [value, setValue] = useState(null);

  const handleBack = () => {
    props.navigation.navigate('workingRequestDtls');
  };
    ...
    <View style={{flex: 1, backgroundColor: '#ffffff'}}>
      ...
      <View>
        <LinearGradient
          ...
          <Text style={styles.headerTitle}>Working Request Details</Text>
        </LinearGradient>
      </View>
              ...
              <View style={{marginTop: 15, marginHorizontal: '4%'}}>
                ...
                <View
                  ...
                  <TouchableOpacity
                    ...
                    <Text
                      style={[styles.mainTitle, {color: '#fff', fontSize: 16}]}>
                      Submit
                    </Text>
                  </TouchableOpacity>
...
export default WorkingRequestDtls;
