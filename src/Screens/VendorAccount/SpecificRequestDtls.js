...
const SpecificRequestDtls = props => {
  const handleBack = () => {
    props.navigation.navigate('specificRequest');
  };
    ...
    <View style={{flex: 1, backgroundColor: '#ffffff'}}>
      ...
      <View>
        <LinearGradient
          ...
          <Text style={styles.headerTitle}>Specific Request Details</Text>
        </LinearGradient>
      </View>
...
export default SpecificRequestDtls;
