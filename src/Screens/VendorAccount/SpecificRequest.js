...
const SpecificRequest = props => {
  ...
  const handleViewDetails = () => {
    props.navigation.navigate('specificRequestDtls');
  };
  return (
        ...
        <View style={styles.mainBoxOuter}>
          <View style={styles.fixInfoDiv}>
            <View
              ...
              <Text style={[styles.mainTitle, styles.greyText]}>Specific Maintenance Request(1)</Text>
              <TouchableOpacity
              ...
              <Text style={[styles.mainTitle, {color: '#fff', fontSize: 16,textAlign:'center'}]}>
                Filters
              </Text>
            </TouchableOpacity>
            </View>
                      ...
                      <View style={styles.proprtyCardCol}>
                        <View style={styles.proprtyCardRow}>
                          <View style={[styles.proprtyCardRight]}>
                            ...
                            <Text style={[styles.py7, {color: '#707070'}]}>{item.Company}
                            </Text>
                            <Text
                              style={[
                                styles.mediumTitle,
                            ...
                            <Text style={[styles.py7, {color: '#707070'}]}>{item.Property}
                            </Text>
                          </View>
                        </View>
                      </View>
