...
const AssetClass = (props) => {
  const addCardClick = () => {
    // props.history.push("/AssetClassadd");
    props.navigation.navigate('AssetClassadd')

  }
  const AssetClassdtl = () => {
    // props.history.push("/AssetClassdtl");
    props.navigation.navigate('AssetClassdtl')
  }
              ...
              <View style={[styles.columnTwo]}>
                ...
                <View style={[styles.mainHdngBtm, styles.mt10]} >
                  <Text style={styles.textBlue} >
                    <Text style={[styles.mainTitle, styles.greyText,]}>Asset Class</Text> (6)
                  </Text>
                </View>
              </View>
            </View>
            <View style={[styles.prpertyList]}>
              <TouchableOpacity style={styles.proprtyCardItem} backgroundColor={'#ffffff'} onPress={AssetClassdtl}>
                <View style={styles.proprtyCardCol}>
                  <View style={styles.proprtyCardRow}>
                    <View style={[styles.proprtyCardRight]}>
                      <Text style={[styles.mediumTitle, styles.pt8, styles.textBlue,]}>Asset Class Name</Text>
