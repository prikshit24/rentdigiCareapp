...
const TechStaffData = [
    {
        id: 'TES64378225',
        name: 'Pankaj Technical',
        email: 'demotechnical1@yopmail.com',
        contact: '4891567854',
        skill: 'Expert',
        Specialities: 'Electrician,Painter,Lock Smith',
        status: 'Verified',
        completedJob: '',
    },
    {
        id: 'TES51484416',
        name: 'Pankaj Pankaj',
        email: 'demotechnical2@yopmail.com',
        contact: '8253434044',
        skill: 'Skills',
        Specialities: 'Electrician,Painter',
        status: 'Rejected',
        completedJob: '',
    },
];
                ...
                <View style={styles.mainBoxOuter}>
                    <View style={styles.fixInfoDiv}>
                        ...
                        <View
                            ...
                            <Text style={[styles.mainTitle, styles.greyText]}>Verified(1)</Text>
                            <Text style={[styles.mainTitle, styles.greyText]}>Rejected(0)</Text>
                            <Text style={[styles.mainTitle, styles.greyText]}>Suspended(0)</Text>
                        </View>
                            ...
                            <View style={{ marginTop: 15, marginHorizontal: '4%' }}>
                                <View style={{ marginTop: '5%' }}>
                                    ...
                                    <View style={{ marginTop: 10 }}>
                                        <Dropdown
                                            ...
                                            labelField="label"
                                            valueField="value"
                                            value={technicalStaffFilter.specialities}
                                            onChange={item => {
                                                setTechnicalStaffFilter({ ...technicalStaffFilter, specialities: item.value });
                                            }}
                                        />
                                    </View>
                                </View>
                                <View style={{ marginTop: 15 }}>
                                    <Text style={[styles.filtertxtStyle]}>Technical Staff Id</Text>
                                    <View style={{ marginTop: 10 }}>
                                        <TextInput
                                            style={styles.formControlNew}
                                            value={technicalStaffFilter.id}
                                            onChangeText={id => setTechnicalStaffFilter({ ...technicalStaffFilter, id: id })}
                                ...
                                <View style={{ marginTop: 15 }}>
                                    ...
                                    <View style={{ marginTop: 10 }}>
                                        <TextInput
                                            style={styles.formControlNew}
                                            value={technicalStaffFilter.name}
                                            onChangeText={val => setTechnicalStaffFilter({ ...technicalStaffFilter, name: val })}
                                ...
                                <View style={{ marginTop: 15 }}>
                                    ...
                                    <View style={{ marginTop: 10 }}>
                                        <TextInput
                                            style={styles.formControlNew}
                                            value={technicalStaffFilter.contact}
                                            onChangeText={val => setTechnicalStaffFilter({ ...technicalStaffFilter, contact: val })}
                                ...
                                <View style={{ marginTop: '5%' }}>
                                    ...
                                    <View style={{ marginTop: 10 }}>
                                        <Dropdown
                                            ...
                                            labelField="label"
                                            valueField="value"
                                            value={technicalStaffFilter.status}
                                            onChange={item => {
                                                setTechnicalStaffFilter({ ...technicalStaffFilter, status: item.value });
                                            }}
                                        />
                                    </View>
                                </View>
                                <View style={{ marginTop: '5%' }}>
                                    ...
                                    <View style={{ marginTop: 10 }}>
                                        <Dropdown
                                            ...
                                            labelField="label"
                                            valueField="value"
                                            value={technicalStaffFilter.rating}
                                            onChange={item => {
                                                setTechnicalStaffFilter({ ...technicalStaffFilter, rating: item.value });
                                            }}
                                        />
                                    </View>
                                </View>
                ...
                <View style={{ flex: 1, backgroundColor: '#ffffff' }}>
                    ...
                    <View>
                        <LinearGradient
                            ...
                            <Text style={styles.headerTitle}>Technical Staff Details</Text>
                        </LinearGradient>
                    </View>
                    <ScrollView contentContainerStyle={styles.outerContainer}>
                        <View style={styles.mainBoxOuter}>
                                    ...
                                    <View style={styles.proprtyCardCol}>
                                        <View style={styles.proprtyCardRow}>
                                            <View style={[styles.proprtyCardRight]}>
                                                ...
                                                <Text style={[styles.py7, { color: '#707070' }]}>
                                                    Speciality 1,Speciality 2,Speciality 3
                                                </Text>
                                                <Text
                                                    style={[
                                                        styles.mediumTitle,
                                                ...
                                                <Text style={[styles.py7, { color: '#707070' }]}>
                                                    Electrician,Painter,Lock Smith
                                                </Text>
                                                <Text
                                                    style={[
                                                        styles.mediumTitle,
