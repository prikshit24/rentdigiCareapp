...
const Vendors = (props) => {
    ...
    const [vendorFilter, setVendorFilter] = useState({
        specialities: '', id: '', name: '', contact: '', city: '', status: '', rating: '',
    })
                            ...
                            <View style={{ marginTop: 15, marginHorizontal: '4%' }}>
                                <View style={{ marginTop: '5%' }}>
                                    ...
                                    <View style={{ marginTop: 10 }}>
                                        <Dropdown
                                            ...
                                            labelField="label"
                                            valueField="value"
                                            value={vendorFilter.specialities}
                                            onChange={item => {
                                                setVendorFilter({ ...vendorFilter, specialities: item.value });
                                            }}
                                        />
                                    </View>
                                </View>
                                <View style={{ marginTop: 15 }}>
                                    <Text style={[styles.filtertxtStyle]}>Vendor Id</Text>
                                    <View style={{ marginTop: 10 }}>
                                        <TextInput
                                            style={styles.formControlNew}
                                            value={vendorFilter.id}
                                            onChangeText={propertyID => setVendorFilter({ ...vendorFilter, id: propertyID })}
                                ...
                                <View style={{ marginTop: 15 }}>
                                    ...
                                    <View style={{ marginTop: 10 }}>
                                        <TextInput
                                            style={styles.formControlNew}
                                            value={vendorFilter.name}
                                            onChangeText={val => setVendorFilter({ ...vendorFilter, id: val })}
                                ...
                                <View style={{ marginTop: 15 }}>
                                    ...
                                    <View style={{ marginTop: 10 }}>
                                        <TextInput
                                            style={styles.formControlNew}
                                            value={vendorFilter.contact}
                                            onChangeText={val => setVendorFilter({ ...vendorFilter, contact: val })}
                                ...
                                <View style={{ marginTop: 15 }}>
                                    ...
                                    <View style={{ marginTop: 10 }}>
                                        <TextInput
                                            style={styles.formControlNew}
                                            value={vendorFilter.city}
                                            onChangeText={val => setVendorFilter({ ...vendorFilter, city: val })}
                                ...
                                <View style={{ marginTop: '5%' }}>
                                    ...
                                    <View style={{ marginTop: 10 }}>
                                        <Dropdown
                                            ...
                                            onChange={item => {
                                                setVendorFilter({ ...vendorFilter, status: item.value });
                                            }}
                                        />
                                    </View>
                                </View>
                ...
                <View style={{ flex: 1, backgroundColor: '#ffffff' }}>
                    ...
                    <View>
                        <LinearGradient
                            ...
                            <Text style={styles.headerTitle}>Vender Details</Text>
                        </LinearGradient>
                    </View>
                    <ScrollView contentContainerStyle={styles.outerContainer}>
                        <View style={styles.mainBoxOuter}>
