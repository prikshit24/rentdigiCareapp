...
const Property = props => {
    ...
    const [applicationFilter, setApplicationFilter] = useState({
        propertyName: '', applicationName: '', phone: '', status: '', source: ''
    })
                ...
                <View style={styles.mainBoxOuter}>
                    <View style={styles.fixInfoDiv}>
                        ...
                        <View
                            ...
                            <Text style={[styles.mainTitle, styles.greyText]}>Pending(0)</Text>
                            <Text style={[styles.mainTitle, styles.greyText]}>Approved(0)</Text>
                            <Text style={[styles.mainTitle, styles.greyText]}>Denied(0)</Text>
                        </View>
                            ...
                            <View style={{ marginTop: 15, marginHorizontal: '4%' }}>
                                <View style={{ marginTop: '5%' }}>
                                    ...
                                    <View style={{ marginTop: 10 }}>
                                        <Dropdown
                                            ...
                                            labelField="label"
                                            valueField="value"
                                            value={applicationFilter.propertyName}
                                            onChange={item => {
                                                setApplicationFilter({ ...applicationFilter, propertyName: item.value });
                                            }}
                                        />
                                    </View>
                                </View>
                                <View style={{ marginTop: 15 }}>
                                    ...
                                    <View style={{ marginTop: 10 }}>
                                        <TextInput
                                            ...
                                            value={applicationFilter.applicationName}
                                            onChangeText={val => setApplicationFilter({ ...applicationFilter, applicationName: val })}
                                ...
                                <View style={{ marginTop: 15 }}>
                                    ...
                                    <View style={{ marginTop: 10 }}>
                                        <TextInput
                                            style={styles.formControlNew}
                                            value={applicationFilter.phone}
                                            onChangeText={val => setApplicationFilter({ ...applicationFilter, phone: val })}
                                ...
                                <View style={{ marginTop: '5%' }}>
                                    ...
                                    <View style={{ marginTop: 10 }}>
                                        <Dropdown
                                            ...
                                            onChange={item => {
                                                setApplicationFilter({ ...applicationFilter, status: item.value });
                                            }}
                                        />
                                    </View>
                                </View>
                                <View style={{ marginTop: '5%' }}>
                                    ...
                                    <View style={{ marginTop: 10 }}>
                                        <Dropdown
                                            ...
                                            labelField="label"
                                            valueField="value"
                                            value={applicationFilter.source}
                                            onChange={item => {
                                                setApplicationFilter({ ...applicationFilter, source: item.value });
                                            }}
                                        />
                                    </View>
                                </View>
